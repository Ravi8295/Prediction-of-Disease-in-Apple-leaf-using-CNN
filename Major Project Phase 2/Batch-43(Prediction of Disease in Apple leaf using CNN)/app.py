...
def model_predict2(image_path,model):
    ...
    if result == 0:
        return "Apple Leaf is Diagnosis as Scab","result.html"        
    elif result == 1:
        return "Apple Leaf is Diagnosis as Black Rot","result.html"
    elif result == 2:
        return "Apple Leaf is Diagnosis as Cedar Apple Rust","result.html"
    elif result == 3:
        return "Apple Leaf is Diagnosis as HEalthy","result.html"
